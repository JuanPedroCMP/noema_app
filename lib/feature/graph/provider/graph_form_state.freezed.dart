...
mixin _$GraphFormState {
 ...
 String get userId; String get title; String get description; bool get isArchived;
...
@override
int get hashCode => Object.hash(runtimeType,userId,title,description,isArchived);

@override
String toString() {
  return 'GraphFormState(userId: $userId, title: $title, description: $description, isArchived: $isArchived)';
}
...
@useResult
$Res call({
 String userId, String title, String description, bool isArchived
});
...
/// Create a copy of GraphFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? title = null,Object? description = null,Object? isArchived = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String userId,  String title,  String description,  bool isArchived)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GraphFormState() when $default != null:
return $default(_that.userId,_that.title,_that.description,_that.isArchived);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String userId,  String title,  String description,  bool isArchived)  $default,) {final _that = this;
switch (_that) {
case _GraphFormState():
return $default(_that.userId,_that.title,_that.description,_that.isArchived);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String userId,  String title,  String description,  bool isArchived)?  $default,) {final _that = this;
switch (_that) {
case _GraphFormState() when $default != null:
return $default(_that.userId,_that.title,_that.description,_that.isArchived);case _:
  return null;
...
class _GraphFormState implements GraphFormState {
  const _GraphFormState({this.userId = "", this.title = "", this.description = "", this.isArchived = false});
...
/// Create a copy of GraphFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? title = null,Object? description = null,Object? isArchived = null,}) {
