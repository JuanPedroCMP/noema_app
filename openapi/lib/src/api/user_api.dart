...
class UserApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> deleteUserApiV1UserDeleteDelete({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/user/delete';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserOut>> newUserApiV1UserCreatePost({ 
    ...
    final _path = r'/api/v1/user/create';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserOut>> updateUserApiV1UserUpdatePut({ 
    ...
    final _path = r'/api/v1/user/update';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
